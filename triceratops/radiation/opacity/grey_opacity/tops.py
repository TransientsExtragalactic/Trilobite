...
class TOPSOpacity(GreyOpacityLaw):
    ...
    See Also
    --------
    ~triceratops.radiation.opacity.opacity_io.read_tops
    ...
    def get_default_ns(cls) -> "SimpleNamespace":
        ...
        with :func:`~triceratops.radiation.opacity.opacity_io.read_tops` and the result
        is cached at the class level for subsequent calls.

        Returns
        -------
        SimpleNamespace
            Namespace as returned by :func:`~triceratops.radiation.opacity.opacity_io.read_tops`.
        """
        if cls._DEFAULT_NS is None:
            from triceratops.radiation.opacity.opacity_io import read_tops
    ...
    def from_tops(
        ...
        *,
        ...
        ----------
        ns : SimpleNamespace
            Output of :func:`~triceratops.radiation.opacity.opacity_io.read_tops`.
