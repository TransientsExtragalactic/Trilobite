"""Base classes for sampling strategies in Trilobite inference."""
...
class Sampler(ABC):
    """
    Abstract base class for sampling strategies in Trilobite inference.

    This class defines the interface and common functionality for all sampling algorithms
    used in the Trilobite inference framework. Specific sampling methods should inherit
    ...
    integrated into the Trilobite ecosystem.
    """
    ...
    def __init__(self, inference_problem: "InferenceProblem", **kwargs):
        ...
        Parameters
        ----------
        inference_problem: ~trilobite.inference.problem.InferenceProblem
    ...
    def problem(self) -> "InferenceProblem":
        ...
        Returns
        -------
        ~trilobite.inference.problem.InferenceProblem
    ...
    def run(self, **kwargs) -> SamplingResult:
        ...
        Returns
        -------
        ~trilobite.inference.sampling.result.SamplingResult
