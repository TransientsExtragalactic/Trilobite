"""
MPI processing pools for Trilobite parallelism.

This module contains :class:`LikelihoodMPIPool`, a :class:`~trilobite.parallel.base.Pool`
...
.. note::
    ...
    not installed. Install it with ``pip install trilobite[mpi]``.
    ...
    def __init__(
        ...
        if not _MPI_AVAILABLE:
            raise RuntimeError(
                ...
                "Install it with: pip install trilobite[mpi]"
            )
