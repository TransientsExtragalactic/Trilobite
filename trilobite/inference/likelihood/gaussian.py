...
:class:`~trilobite.inference.likelihood.base.Likelihood`), which are responsible for:
...
Notes
-----
For more details on the use of likelihood functions in Trilobite, see :ref:`likelihoods`.
"""
