...
:mod:`triceratops.radiation.synchrotron.SEDs`, the numerical engines are designed
...
See Also
--------
:mod:`triceratops.radiation.synchrotron.SEDs.one_zone`
...
class NumericalSynchrotronEngine:
    ...
    Triceratops synchrotron framework for evaluating synchrotron emissivities,
