...
See Also
--------
:mod:`trilobite.dynamics.accretion.utils` : Low-level disk utility functions (T_eff profile, SED integrals, etc.)
:mod:`trilobite.dynamics.accretion.one_zone` : Time-dependent one-zone disk models.
"""
...
from trilobite.radiation.blackbody import _log_planck_fnu_cgs
...
class AlphaDisk(ThinDiskBase):
    ...
    .. code-block:: python
        ...
        from astropy import constants as const
        from trilobite.dynamics.accretion import (
            AlphaDisk,
        )
