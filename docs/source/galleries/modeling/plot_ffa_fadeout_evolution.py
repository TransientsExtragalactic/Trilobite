...
# 3. The FFA optical depth spectrum :math:`\tau_{\rm ff}(\nu)`.
...
# -----------------------------------------------
#
# The FFA optical depth spectrum :math:`\tau_{\rm ff}(\nu)` at each epoch.
...
#    :header-rows: 1
#
#    * - Low-frequency slope :math:`\alpha = d\log F/d\log\nu`
#      - Dominant absorption
#      - Physical interpretation
#    * - :math:`\alpha \approx +2.0`
#      - FFA
#      - Dense ionized CSM; :math:`\dot{M}` is high
#    * - :math:`\alpha \approx +2.5`
#      - SSA
#      - Moderate CSM; equipartition analysis applicable
#    * - :math:`\alpha = -(p-1)/2 \approx -1`
#      - None (optically thin)
#      - Late times; expansion velocity measurable from :math:`R/t`
#
