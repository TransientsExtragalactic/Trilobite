"""
Abstract base classes for Trilobite models.

This module defines the abstract base class structure for all Trilobite models. It is the
...
At their core, all of the models in Trilobite inherit from the
:class:`~trilobite.models.core.base.Model` abstract base class, which
...
class Model(ABC):
    r"""
    Abstract base class for all Trilobite models.

    At their core, all models in Trilobite are wrappers around a set of physical
    ...
    This abstract base class defines the structure that all Trilobite models must adhere to. Specifically, each
    model must declare its parameters and variables as class-level attributes, and implement the
    :meth:`~trilobite.models.core.base.Model._forward_model` method to compute the model's outputs.
    """
    ...
    the model's :meth:`~trilobite.models.core.base.Model._forward_model` evaluation method.
    ...
    def _forward_model_tupled(
        ...
        :meth:`~trilobite.models.core.base.Model._forward_model` to return
