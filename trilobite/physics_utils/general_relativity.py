r"""
General relativistic utility functions for Trilobite models.
...
from trilobite.physics_utils.constants import _log_c_cgs, _log_G_cgs
...
def compute_gravitational_radius(mass: "_UnitBearingArrayLike") -> u.Quantity:
    ...
    .. code-block:: python
        ...
        from astropy import units as u
        from trilobite.physics_utils.general_relativity import (
