"""
Sampling output handling for Trilobite.

This module contains the :class:`~trilobite.inference.sampling.result.SamplingResult` class,
...
class SamplingResult(ABC):
    ...
    A :class:`~trilobite.inference.sampling.result.SamplingResult` stores posterior samples along with the
    associated :class:`~trilobite.inference.problem.InferenceProblem` required
    ...
    def from_hdf5(
        ...
        """
        Reconstruct a :class:`~trilobite.inference.sampling.result.SamplingResult` from disk.
        ...
        :meth:`~trilobite.inference.problem.InferenceProblem.from_dict`.
        ...
        SamplingResult
            ...
            specifies a subclass of :class:`~trilobite.inference.sampling.result.SamplingResult`, that subclass
        ...
        # --------------------------------------------------
        from trilobite.inference import InferenceProblem
...
class MCMCSamplingResult(SamplingResult):
    ...
    This subclass of :class:`~trilobite.inference.sampling.result.SamplingResult` stores samples with explicit
