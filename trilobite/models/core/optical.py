...
if TYPE_CHECKING:
    from trilobite._typing import _ModelParametersInputRaw, _ModelVariablesInput, _ModelVariablesInputRaw
...
class _FilterBundleMixin:
    ...
    def bundle(self) -> "FilterBundle":
        """The attached :class:`~trilobite.utils.phot_utils.FilterBundle`."""
        return self._bundle
