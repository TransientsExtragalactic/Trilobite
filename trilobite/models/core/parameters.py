"""
Model parameter declarations for Trilobite models.

This module defines the :class:`ModelParameter` class, which encapsulates metadata
and validation logic for parameters used in Trilobite physical and phenomenological
...
class ModelParameter:
    ...
    A :class:`ModelParameter` represents a single scalar parameter in a Trilobite
...
class ModelVariable:
    ...
    Trilobite model (e.g., frequency, time, radius). Variables are *not*
