...
| Class                                         | Description                                                  |
+===============================================+==============================================================+
| :class:`~triceratops.radiation.opacity.grey_  | Constant grey opacity:                                       |
...
|                          | :func:`~triceratops.radiation.opacity.utils.load_opal_opacity`  |
...
class ElectronScatteringOpacity(GreyOpacityLaw):
    ...
    See Also
    --------
    ~triceratops.radiation.opacity.grey_opacity.base.ConstantGreyOpacity : Generic constant opacity without
    ...
    def _initialize_C_object(self, kappa_es=0.34):
        from triceratops.radiation.opacity.grey_opacity.rosseland._electron_scattering import (
...
class KramersFFOpacity(GreyOpacityLaw):
    ...
    def _initialize_C_object(self, kappa0):
        from triceratops.radiation.opacity.grey_opacity.rosseland._kramers import C_KramersOpacity
...
class KramersFFESOpacity(GreyOpacityLaw):
    ...
    def _initialize_C_object(self, kappa0, kappa_es=0.34):
        from triceratops.radiation.opacity.grey_opacity.rosseland._kramers_es import C_KramersESOpacity
