r"""
Newtonian gravitational physics utilities for Trilobite models.
...
from trilobite.physics_utils.constants import _log_G_cgs
...
def compute_tidal_radius(
    ...
    .. code-block:: python
        ...
        from astropy import units as u
        from trilobite.physics_utils.gravity import (
