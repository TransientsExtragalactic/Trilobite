...
:class:`~trilobite.radiation.opacity.base.OpacityLaw` instances, along
...
from trilobite.radiation.opacity.grey_opacity.base import ConstantGreyOpacity
...
from trilobite.radiation.opacity.grey_opacity.tops import TOPSOpacity
...
def get_opacity(
    ...
    **kwargs,
    ...
    r"""
    Resolve an opacity specification into an :class:`~trilobite.radiation.opacity.base.OpacityLaw` instance.
    ...
    Parameters
    ----------
    opacity : str, float, ~astropy.units.Quantity or ~trilobite.radiation.opacity.base.OpacityLaw
        ...
        - :class:`str`: The name of a specific opacity type (see table below). In this case, the
          ...
          :meth:`~trilobite.radiation.opacity.base.OpacityLaw.load_default` method.
        ...
        - :class:`~trilobite.radiation.opacity.base.OpacityLaw`: Returned unchanged.
    ...
    **kwargs
        ...
        corresponding class's :meth:`~trilobite.radiation.opacity.base.OpacityLaw.load_default` method
...
def load_opal_opacity(
    ...
    *,
    ...
    The OPAL opacities provided by default in Trilobite are those from
    ...
    .. note::
        ...
        :meth:`~trilobite.radiation.opacity.grey_opacity.rosseland.models.OPALOpacity.load_default`,
    ...
    Returns
    -------
    ~trilobite.radiation.opacity.grey_opacity.rosseland.models.OPALOpacity
...
def load_tops_opacity(
    *,
    ...
    :meth:`~trilobite.radiation.opacity.grey_opacity.tops.TOPSOpacity.load_default`.
    ...
    table_path : str or ~pathlib.Path, optional
        ...
        :func:`~trilobite.radiation.opacity.opacity_io.read_tops`.
    ...
    Returns
    -------
    ~trilobite.radiation.opacity.grey_opacity.tops.TOPSOpacity
