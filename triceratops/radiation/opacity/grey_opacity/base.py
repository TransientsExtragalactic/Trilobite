...
:class:`GreyOpacityLaw` subclasses :class:`~triceratops.radiation.opacity.base.OpacityLaw`
...
class GreyOpacityLaw(OpacityLaw):
    ...
    Specialises :class:`~triceratops.radiation.opacity.base.OpacityLaw` for
    ...
    See Also
    --------
    ~triceratops.radiation.opacity.grey_opacity.base.ConstantGreyOpacity : Concrete constant-opacity implementation.
    triceratops.radiation.opacity.opacity_base.C_GreyOpacityBase : C-level companion.
    """
...
class ConstantGreyOpacity(GreyOpacityLaw):
    ...
    .. code-block:: python
        ...
        from triceratops.radiation.opacity.grey_opacity import (
            ConstantGreyOpacity,
        )
